...
namespace Nhom2_QuanLySinhVien.QuanLyMonHoc
{
	public partial class frm_QuanLyMonHoc_Bac : Form
	{
		...
		private void btn_reload_Bac_Click(object sender, EventArgs e)
		{
			frm_XemThongTinMonHoc_Bac_Load(sender, e);
		}
		...
		private void txt_TimKiem_Bac_TextChanged(object sender, EventArgs e)
		{
